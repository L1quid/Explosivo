...
public:
	...
	*/
    virtual void run(int max_send_bytes=-1, int max_recv_bytes=-1, int *bytes_sent=NULL, int *bytes_rcvd=NULL, int pollwait=-1);
  ...
  protected:
    ...
    bool getbfromrecv(int pos, int remove, char *b); // used by recv_line*
   /*
