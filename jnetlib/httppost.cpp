...
*/
void JNL_HTTPPost::_preparefield(const std::string &name)
{
	std::string cd;
...
**  addfield, adds field
*/
int JNL_HTTPPost::addfield(const char *name, const char *val)
{
...
**  addfile, adds file
*/
int JNL_HTTPPost::addfile(const char *name, const char *mimetype, const char *filename, const char *filepath)
{
	struct stat buffer;
